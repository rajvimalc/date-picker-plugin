 ...
 */
public class DateTimePickerDefinition extends PickerDefinition {

    private static final String DEFAULT_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm";

    private static final String DISPLAY_NAME = "Date Time Picker Parameter";

    @DataBoundConstructor
    public DateTimePickerDefinition(String name, String defaultValue, String description) {
